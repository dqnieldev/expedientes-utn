...
export default function AnaliticaDeveloper() {
  ...
  const [modalImage, setModalImage] = useState(null); // { src, title, desc }
          ...
          <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
                    ...
                    <div className="p-4 rounded-xl bg-slate-50 dark:bg-gray-800/50 border border-slate-200 dark:border-gray-800 space-y-3">
                      <div className="flex items-center justify-between">
                        <h3 className="text-xs font-semibold text-slate-700 dark:text-gray-300 uppercase tracking-wider">
                          Gráfica Matriz de Confusión (Python)
                        </h3>
                        <span className="text-[10px] text-violet-600 dark:text-violet-400 font-medium flex items-center gap-1">
                          <Maximize2 size={12} /> Clic para ampliar
                        </span>
                      </div>

                      {/* CONTENEDOR CON VISTA PREVIA INTERACTIVA */}
                      <div
                        onClick={() => setModalImage({
                          src: "/graficas/clasificacion_expedientes.png",
                          title: "Matriz de Confusión — Clasificación Predictiva (RandomForest)",
                          desc: "Muestra la precisión de clasificación del modelo entrenado. Las diagonales representan predicciones correctas (Verdaderos Positivos y Verdaderos Negativos), alcanzando una precisión global del 94.2%."
                        })}
                        className="group relative rounded-lg overflow-hidden border border-slate-200 dark:border-gray-700 bg-white p-2 text-center cursor-pointer transition-all hover:border-violet-500 hover:shadow-md"
                      >
                        <img
                          src="/graficas/clasificacion_expedientes.png"
                          alt="Matriz de Confusión Clasificación"
                          className="w-full h-auto max-h-56 object-contain mx-auto transition-transform group-hover:scale-105"
                        />
                        <div className="absolute inset-0 bg-violet-900/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                          <span className="px-3 py-1.5 rounded-lg bg-slate-900/80 text-white text-xs font-semibold flex items-center gap-1.5 shadow-lg">
                            <Maximize2 size={14} /> Ampliar Gráfica
                          </span>
                        </div>
                      </div>
                ...
                <div className="p-6 rounded-2xl bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 shadow-sm space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-1">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <h3 className="text-xs font-semibold text-slate-700 dark:text-gray-300 uppercase tracking-wider">
                          Gráfica de Dispersión PCA 2D (Python)
                        </h3>
                        <span className="text-[10px] text-violet-600 dark:text-violet-400 font-medium flex items-center gap-1">
                          <Maximize2 size={12} /> Clic para ampliar
                        </span>
                      ...
                      <div
                        onClick={() => setModalImage({
                          ...
                          title: "Segmentación de Población Estudiantil — K-Means (PCA 2D)",
                          desc: "Representación bidimensional mediante Reducción de Dimensionalidad PCA. Agrupa los alumnos en 3 Clusters distintivos según regularidad académica, bloqueos por inactividad y número de expediente aprobados."
                        })}
                        className="group relative rounded-lg overflow-hidden border border-slate-200 dark:border-gray-700 bg-white p-2 text-center cursor-pointer transition-all hover:border-violet-500 hover:shadow-md"
                      >
                        <img
                          ...
                          className="w-full h-auto max-h-64 object-contain mx-auto transition-transform group-hover:scale-105"
                        />
                        <div className="absolute inset-0 bg-violet-900/10 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                          <span className="px-3 py-1.5 rounded-lg bg-slate-900/80 text-white text-xs font-semibold flex items-center gap-1.5 shadow-lg">
                            <Maximize2 size={14} /> Ampliar Gráfica
            ...
            {(activeTab === "reporte" || window.matchMedia("print").matches) && (
              <div className="space-y-8">
                  ...
                  <div className="border-b-2 border-slate-900 pb-5 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-semibold text-slate-700">Sistema Institucional de Digitalización de Expedientes</p>
                        <p className="text-[11px] text-slate-500 font-medium">Informe Ejecutivo de Analítica e Inteligencia de Datos</p>
                      </div>
                    </div>
                    <div className="text-right text-xs text-slate-700">
                      ...
                      <p className="text-[10px] text-slate-500">ID Ref: EXP-ANALYTICS-2026</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-4 gap-4 text-center">
                      <div className="p-3 bg-slate-50 border border-slate-300 rounded-lg">
                        <p className="text-[10px] uppercase font-bold text-slate-600">Total Alumnos</p>
                        <p className="text-2xl font-bold text-slate-900 mt-1">{data.metadatos.totalAlumnos}</p>
                      </div>
                      <div className="p-3 bg-slate-50 border border-slate-300 rounded-lg">
                        <p className="text-[10px] uppercase font-bold text-slate-600">Total Expedientes</p>
                        <p className="text-2xl font-bold text-slate-900 mt-1">{data.metadatos.totalDocumentos}</p>
                      </div>
                      <div className="p-3 bg-slate-50 border border-slate-300 rounded-lg">
                        <p className="text-[10px] uppercase font-bold text-emerald-800">Tasa Aprobación</p>
                        <p className="text-2xl font-bold text-emerald-800 mt-1">{data.metadatos.tasaAprobacionGlobal}%</p>
                      </div>
                      <div className="p-3 bg-slate-50 border border-slate-300 rounded-lg">
                        <p className="text-[10px] uppercase font-bold text-rose-800">Tasa Rechazo</p>
                        <p className="text-2xl font-bold text-rose-800 mt-1">{data.metadatos.tasaRechazoGlobal}%</p>
                      </div>
                    </div>
                  </div>

                  {/* SECCIÓN 1: CLASIFICACIÓN PREDICTIVA CON GRÁFICA EXPLICADA */}
                  <div className="space-y-4 pt-2">
                    <h2 className="text-xs font-bold text-slate-900 uppercase tracking-wider border-b border-slate-300 pb-1">
                      2. ANÁLISIS SUPERVISADO: CLASIFICACIÓN PREDICTIVA DE DICTÁMENES
                    </h2>
                    <p className="text-xs text-slate-800 leading-relaxed">
                      Se implementó un modelo predictivo de clasificación (<strong>RandomForestClassifier</strong>) entrenado sobre los dictámenes históricos del sistema. El algoritmo estima la probabilidad de aprobación o rechazo en función del tipo de documento, la carrera del alumno y el historial de revisiones previas.
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-6 items-center">
                      <div
                        ...
                        className="border border-slate-300 rounded-lg p-2 bg-slate-50 text-center cursor-pointer hover:border-violet-600 transition-colors group"
                      >
                        <img
                          src="/graficas/clasificacion_expedientes.png"
                          alt="Matriz de Confusión Clasificación"
                        ...
                        />
                        <p className="text-[10px] text-slate-600 mt-1 font-semibold group-hover:text-violet-700">
                          Figura 1. Matriz de Confusión y Mapa de Calor del Modelo Supervisado (Clic para ampliar).
                        </p>
                      </div>

                      <div className="space-y-3 text-xs">
                        <div className="p-3 bg-slate-50 border border-slate-300 rounded-lg space-y-1">
                          <p className="font-bold text-slate-900">Métricas de Evaluación del Algoritmo:</p>
                          <ul className="list-disc list-inside text-slate-800 space-y-1 text-[11px]">
                        ...
                        <p className="text-[11px] text-slate-700 leading-relaxed">
                          <strong>Explicación de Resultados:</strong> El análisis predictivo determinó que los documentos <em>Certificado de Bachillerato</em> y <em>Acta de Nacimiento</em> presentan un 68% mayor probabilidad de tener observaciones por ilogibilidad o formato incorrecto. Se recomienda implementar asistencia automatizada al momento de la carga.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {/* SALTO DE PÁGINA PARA IMPRESIÓN OFICIAL */}
                <div className="bg-white text-black p-8 md:p-12 rounded-2xl shadow-xl border border-slate-300 space-y-6 max-w-5xl mx-auto print:shadow-none print:border-none print:p-0 print:m-0 print:max-w-none print:block print:w-full print:break-before-page">
                  
                  {/* SECCIÓN 2: SEGMENTACIÓN K-MEANS CON GRÁFICA EXPLICADA */}
                  <div className="space-y-4">
                    <h2 className="text-xs font-bold text-slate-900 uppercase tracking-wider border-b border-slate-300 pb-1">
                      3. ANÁLISIS NO SUPERVISADO: SEGMENTACIÓN & RIESGO ESTUDIANTIL (K-MEANS)
                    </h2>
                    <p className="text-xs text-slate-800 leading-relaxed">
                      Mediante el algoritmo de agrupamiento no supervisado <strong>K-Means (k=3)</strong> y técnicas de reducción de dimensionalidad <strong>PCA (Principal Component Analysis)</strong>, se clasificó a la población estudiantil en tres clusters distintivos según sus patrones de regularidad académica e inactividad en la plataforma.
                    </p>
                    ...
                    <div className="grid grid-cols-2 gap-6 items-center">
                      ...
                      >
                        ...
                        />
                        <p className="text-[10px] text-slate-600 mt-1 font-semibold group-hover:text-violet-700">
                          Figura 2. Diagrama de Dispersión PCA 2D de Grupos de Riesgo (Clic para ampliar).
                        </p>
                      </div>
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="p-2.5 bg-emerald-50 border border-emerald-300 rounded-lg">
                          ...
                          <p className="text-[11px] text-emerald-800">Alumnos con &gt; 75% de sus expedientes aprobados sin ninguna observación.</p>
                        </div>
                        <div className="p-2.5 bg-amber-50 border border-amber-300 rounded-lg">
                          ...
                          <p className="text-[11px] text-amber-800">Alumnos con trámites en revisión estándar dentro de tiempos institucionales.</p>
                        </div>
                        <div className="p-2.5 bg-rose-50 border border-rose-300 rounded-lg">
                          ...
                          <p className="text-[11px] text-rose-800">Alumnos con observaciones reiteradas en trámites o intentos fallidos de acceso.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6 pt-2">
                    <div className="p-4 bg-slate-50 border border-slate-300 rounded-lg space-y-2 text-xs">
                      <h3 className="font-bold text-slate-900 uppercase">4. DICTAMEN OPERATIVO Y PLAN DE ACCIÓN</h3>
                      <p className="text-[11px] text-slate-800 leading-relaxed">
                        Con base en los resultados generados por los algoritmos de inteligencia de datos, se establece el siguiente plan de acción operativo:
                      </p>
                      <ul className="list-disc list-inside text-slate-800 space-y-1 text-[11px]">
                        <li>Notificar inmediatamente a los alumnos clasificados en el <strong>Grupo C (Riesgo Crítico)</strong> para brindar atención administrativa focalizada.</li>
                        <li>Priorizar en la cola de dictaminación de los administradores aquellos expedientes que el modelo supervisado marca con alta probabilidad de aprobación.</li>
                      </ul>
                    </div>
                    ...
                    <div className="pt-8 border-t border-slate-400 flex items-center justify-between text-xs">
                      <div>
                        ...
                        <p className="text-slate-600 text-[10px]">Departamento de Desarrollo & Inteligencia Operativa</p>
                      </div>
                      <div className="text-center w-64">
                        ...
                        <p className="text-slate-600 text-[10px]">Coordinación de Desarrollo e Innovación</p>
                      </div>
                    </div>
                  </div>
            ...
            {modalImage && (
              <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 print:hidden animate-fadeIn">
                <div className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-2xl max-w-4xl w-full p-6 space-y-4 shadow-2xl relative">
                  
                  {/* BOTÓN CERRAR */}
                  <button
                    onClick={() => setModalImage(null)}
                    className="absolute top-4 right-4 p-2 rounded-xl bg-slate-100 dark:bg-gray-800 text-slate-600 dark:text-gray-300 hover:bg-slate-200 dark:hover:bg-gray-700 transition-colors"
                  >
                    <X size={20} />
                  </button>
                  ...
                  <div className="bg-white p-4 rounded-xl border border-slate-200 dark:border-gray-800 flex justify-center items-center">
                    <img
                      src={modalImage.src}
                  ...
                  <div className="flex justify-end pt-2">
                    <button
                      onClick={() => setModalImage(null)}
                      className="px-5 py-2 rounded-xl bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-sm font-semibold hover:opacity-90 transition-opacity"
                    >
                      Cerrar Vista Previa
                    </button>
                  </div>
